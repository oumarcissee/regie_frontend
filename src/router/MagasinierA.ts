const MagasinierA = {
    ...
    children: [
        {
            name: 'ModernMagA',
            path: '/dashboards/modern/mag',
            component: () => import('@/views/dashboard/modern/indexMagA.vue')
        },
    //     {
    //         name: 'eCommerce',
    ...
    //     //     path: '/tables/datatables/virtual',
    //     //     component: () => import('@/views/tables/datatables/VirtualTable.vue')
    //     // },
    //     {
    //         name: 'Alert',
